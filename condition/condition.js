...
if ((userAge >= 18, drivingLicense == true)) {
  document.write("Selamat berkendara");
} else if (userAge < 18) {
  document.write("Anda belum cukup umur");
} else if (drivingLicense == false) {
  document.write("Diharapkan untuk membuat SIM terlebih dahulu");
}
...
switch (unit) {
  /// EDIT HERE
  case "K": {
    document.write(temperature + 273, 15);
    break;
  }
  case "F": {
    document.write((temperature * 9) / 5 + 32);
    break;
  }
  case "C": {
